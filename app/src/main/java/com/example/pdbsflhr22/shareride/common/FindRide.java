...
import com.example.pdbsflhr22.shareride.R;
import com.example.pdbsflhr22.shareride.RideDetails;

import java.util.ArrayList;
import java.util.HashMap;

/**
 * Created by KaNza_Yahya on 03/04/2018.
 */
...
public class FindRide  extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter adapter = new SimpleAdapter(FindRide.this, mArrayListMembers, R.layout.ride_items_listview, from, to);
        ...
        simpleList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position <= mArrayListMembers.size()){
                    Intent myintent = new Intent(view.getContext(),RideDetails.class);
                    startActivityForResult(myintent,0);
                }
            }
        });
      /*  for(int i = 0 ; i <= mArrayListMembers.size(); i++){}*/
